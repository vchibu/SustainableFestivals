...
try:
    ...
    # Calculate cost for each leg of the departure and return trips
    ...
    lowest_carbon_dep = carbon_calculator.select_lowest_carbon_options(dep_costs)
    lowest_carbon_ret = carbon_calculator.select_lowest_carbon_options(ret_costs)

     # Download the lowest carbon options to CSV files
    lowest_carbon_dep.to_csv("Data/ChosenTrips/lowest_carbon_departure.csv", index=False)
    lowest_carbon_ret.to_csv("Data/ChosenTrips/lowest_carbon_return.csv", index=False)
    ...
    metrics = analysis.analyze(
        output_csv="Data/FinalStatistics/CSVs/min_carbon_metrics.csv",  # Optional: also save as CSV
        output_md="Data/FinalStatistics/MDs/min_carbon_report.md",     # Save as Markdown
